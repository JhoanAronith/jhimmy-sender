...
📞 972107359
(Asesor: SANTIAGO DIAZ)

💬 Le brindaré una atención rápida y personalizada

📌 Aproveche esta oportunidad exclusiva con Santander Consumer (Anteriormente CrediScotia).""",
...
📌 No pierda esta oportunidad con Santander Consumer (Anteriormente CrediScotia).""",
...
📌 Beneficio exclusivo con Santander Consumer (Anteriormente CrediScotia).""",
...
📌 Aproveche esta campaña exclusiva de Santander Consumer (Anteriormente CrediScotia).""",
...
📌 No deje pasar esta oportunidad con Santander Consumer (Anteriormente CrediScotia)."""
]


def obtener_plantilla_aleatoria():
...
def main():
    ...
    if st.session_state.df_master is not None:
        ...
        for i, fila in df_pagina.iterrows():
            ...
            stable_id = fila['_id']
            plantilla = obtener_plantilla_aleatoria()
